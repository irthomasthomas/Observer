...
function PushoverIcon() {
    return React.createElement(Send, { className: "w-3.5 h-3.5" });
}

function SmsIcon() {
    return React.createElement(MessageSquarePlus, { className: "w-3.5 h-3.5" });
}
 ...
 */
export function detectAgentSensors(systemPrompt: string): DetectedSensor[] {
 ...
 */
export function detectAgentTools(code: string): DetectedTool[] {
 ...
 */
export function detectAgentCapabilities(systemPrompt: string, code: string): AgentCapabilities {
    return {
        sensors: detectAgentSensors(systemPrompt),
        tools: detectAgentTools(code)
    };
}
